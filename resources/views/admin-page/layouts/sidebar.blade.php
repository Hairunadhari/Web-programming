      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown {{ request()->is('admin/dashboard') ? 'active' : '' }}">
          ...
          <ul class="dropdown-menu">
            <li class="{{ request()->is('admin/dashboard') ? 'active' : '' }}"><a class="nav-link" href="/admin/dashboard">Ecommerce Dashboard</a></li>
          </ul>
        </li>
        ...
        <li class="{{ request()->is('admin/transactions') ? 'active' : '' }}"><a class="nav-link " href="/admin/transactions"><i class="far fa-file"></i> <span>Transactions</span></a></li>
